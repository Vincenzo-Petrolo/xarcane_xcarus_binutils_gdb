...
#define MATCH_XMK0 0x7b
#define MASK_XMK0 0x6007fff
#define MATCH_XMK1 0x107b
#define MASK_XMK1 0x6007fff
#define MATCH_XMK10 0x400207b
#define MASK_XMK10 0x6007fff
#define MATCH_XMK11 0x400307b
#define MASK_XMK11 0x6007fff
#define MATCH_XMK12 0x600007b
#define MASK_XMK12 0x6007fff
#define MATCH_XMK13 0x600107b
#define MASK_XMK13 0x6007fff
#define MATCH_XMK14 0x600207b
#define MASK_XMK14 0x6007fff
#define MATCH_XMK15 0x600307b
#define MASK_XMK15 0x6007fff
#define MATCH_XMK2 0x207b
#define MASK_XMK2 0x6007fff
#define MATCH_XMK3 0x307b
#define MASK_XMK3 0x6007fff
#define MATCH_XMK4 0x200007b
#define MASK_XMK4 0x6007fff
#define MATCH_XMK5 0x200107b
#define MASK_XMK5 0x6007fff
#define MATCH_XMK6 0x200207b
#define MASK_XMK6 0x6007fff
#define MATCH_XMK7 0x200307b
#define MASK_XMK7 0x6007fff
#define MATCH_XMK8 0x400007b
#define MASK_XMK8 0x6007fff
#define MATCH_XMK9 0x400107b
#define MASK_XMK9 0x6007fff
#define MATCH_XMR_B 0x202b
#define MASK_XMR_B 0x6007fff
#define MATCH_XMR_H 0x102b
#define MASK_XMR_H 0x6007fff
#define MATCH_XMR_W 0x2b
#define MASK_XMR_W 0x6007fff
...
/* Vendor-specific (POLITO) ARCANE custom near-memory matrix instructions */
DECLARE_INSN(xmk0, MATCH_XMK0, MASK_XMK0)
DECLARE_INSN(xmk1, MATCH_XMK1, MASK_XMK1)
DECLARE_INSN(xmk10, MATCH_XMK10, MASK_XMK10)
DECLARE_INSN(xmk11, MATCH_XMK11, MASK_XMK11)
DECLARE_INSN(xmk12, MATCH_XMK12, MASK_XMK12)
DECLARE_INSN(xmk13, MATCH_XMK13, MASK_XMK13)
DECLARE_INSN(xmk14, MATCH_XMK14, MASK_XMK14)
DECLARE_INSN(xmk15, MATCH_XMK15, MASK_XMK15)
DECLARE_INSN(xmk2, MATCH_XMK2, MASK_XMK2)
DECLARE_INSN(xmk3, MATCH_XMK3, MASK_XMK3)
DECLARE_INSN(xmk4, MATCH_XMK4, MASK_XMK4)
DECLARE_INSN(xmk5, MATCH_XMK5, MASK_XMK5)
DECLARE_INSN(xmk6, MATCH_XMK6, MASK_XMK6)
DECLARE_INSN(xmk7, MATCH_XMK7, MASK_XMK7)
DECLARE_INSN(xmk8, MATCH_XMK8, MASK_XMK8)
DECLARE_INSN(xmk9, MATCH_XMK9, MASK_XMK9)
DECLARE_INSN(xmr_b, MATCH_XMR_B, MASK_XMR_B)
DECLARE_INSN(xmr_h, MATCH_XMR_H, MASK_XMR_H)
DECLARE_INSN(xmr_w, MATCH_XMR_W, MASK_XMR_W)
